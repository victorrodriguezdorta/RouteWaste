import type { ContainerDailyStateJsonResponse } from '@/adapter/http/response/infrastructure-plan/container-daily-state-json-response';
import type { InfrastructurePlanClusterJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-cluster-json-response';
import type { InfrastructurePlanDailyPlanJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-daily-plan-json-response';
import type { InfrastructurePlanDetailJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-detail-json-response';
import type { InfrastructurePlanFacilityJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-facility-json-response';
import type { InfrastructurePlanMoneyJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-money-json-response';
import type { InfrastructurePlanStopJsonResponse } from '@/adapter/http/response/infrastructure-plan/infrastructure-plan-stop-json-response';
import type { StopAlertJsonResponse } from '@/adapter/http/response/infrastructure-plan/stop-alert-json-response';
...
import { infrastructurePlanExecutionStateFromString } from '@/domain/enumerate/infrastructure-plan-execution-state';
...
export class InfrastructurePlanDetailMapper {
  ...
  static toReadModel(data: InfrastructurePlanDetailJsonResponse): InfrastructurePlanDetail {
    ...
    const executionState = infrastructurePlanExecutionStateFromString(data.executionState);
    const failureReason =
      typeof data.failureReason === 'string' && data.failureReason.length > 0
        ? data.failureReason
        : null;
