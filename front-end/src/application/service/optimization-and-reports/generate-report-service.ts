...
import type { GenerateReportCommand, GenerateReportResult, GenerateReportUseCase } from '../../usecase/optimization-and-reports/generate-report/generate-report-use-case';
