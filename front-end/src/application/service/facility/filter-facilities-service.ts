...
import type { FilterFacilitiesUseCase, FilterFacilitiesCommand, FilterFacilitiesResult } from '../../usecase/FacilityManagement/FilterFacilities/filter-facilities-use-case';
