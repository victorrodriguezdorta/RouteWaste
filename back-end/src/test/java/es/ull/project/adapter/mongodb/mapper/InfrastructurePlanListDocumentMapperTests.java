...
class InfrastructurePlanListDocumentMapperTests {
    ...
    @Test
    void toInfrastructurePlan_mapsProjectedDocumentWithoutNestedCollections() {
        UUID planId = UUID.randomUUID();
        Document estimatedTotalCost = new Document()
                .append(MongoFields.ESTIMATED_TOTAL_COST_AMOUNT, 1250.5)
                .append(MongoFields.ESTIMATED_TOTAL_COST_CURRENCY, "EUR");
        ...
        Document document = new Document()
                ...
                .append(MongoFields.EXECUTED_AT, "2026-06-01T10:15:30Z")
    ...
    @Test
    void toInfrastructurePlan_mapsRunningExecutionAsRunningValidity() {
        UUID planId = UUID.randomUUID();
        Document document = new Document()
                .append(MongoFields.ID, planId)
                .append(MongoFields.VALIDITY_STATE, InfrastructurePlanValidityState.VALID.name())
