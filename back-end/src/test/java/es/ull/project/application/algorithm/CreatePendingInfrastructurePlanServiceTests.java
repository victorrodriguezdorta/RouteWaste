...
class CreatePendingInfrastructurePlanServiceTests {
    ...
    /**
     * Tests that a pending infrastructure plan is persisted with request metadata.
     */
    @Test
    void createPendingPersistsRunningPlaceholderWithRequestMetadata() {
    ...
    /**
     * Tests that creating a pending infrastructure plan requires a maximum budget.
     */
    @Test
    void createPendingRequiresMaxBudget() {
        CreatePendingInfrastructurePlanService service =
                new CreatePendingInfrastructurePlanService(this.infrastructurePlanRepository);
        assertThrows(
