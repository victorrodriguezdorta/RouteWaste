...
class ServiceAssignmentTests {
    ...
    void constructor_1_right() {
        ...
        ServiceAssignment sa = new ServiceAssignment(containerId, facilityId, demand, distance, serviceTime, cost);

        assertEquals(containerId, sa.getContainerId());
        assertEquals(facilityId, sa.getFacilityId());
    ...
    void constructor_containerId_undefined() {
        ...
        IllegalArgumentException exception = assertThrows(
            ...
            () -> new ServiceAssignment(containerId, facilityId, randomWasteDemand(), randomDistance(), randomServiceTime(), randomTransportCost())
        );
    ...
    void constructor_demand_undefined() {
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> new ServiceAssignment(randomId(), randomId(), null, randomDistance(), randomServiceTime(), randomTransportCost())
        );
    ...
    void constructor_distance_undefined() {
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), null, randomServiceTime(), randomTransportCost())
        );
    ...
    void constructor_serviceTime_undefined() {
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), randomDistance(), null, randomTransportCost())
        );
    ...
    void constructor_transportCost_undefined() {
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), randomDistance(), randomServiceTime(), null)
        );
    ...
    @Test
    void equalsMethod() {
        ServiceAssignment sa1 = new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), randomDistance(), randomServiceTime(), randomTransportCost());
        ServiceAssignment sa2 = new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), randomDistance(), randomServiceTime(), randomTransportCost());
    ...
    void validatePolicies_valid() {
        ServiceAssignment sa = new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), Distance.fromMeters(100.0), new ServiceTime(5.0), randomTransportCost());
    ...
    void validatePolicies_violation_distance() {
        ServiceAssignment sa = new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), Distance.fromMeters(20000.0), new ServiceTime(5.0), randomTransportCost());
    ...
    @Test
    void toStringMethod() {
        ServiceAssignment sa = new ServiceAssignment(randomId(), randomId(), randomWasteDemand(), randomDistance(), randomServiceTime(), randomTransportCost());
        String expected = String.format(
            "ServiceAssignment={id=%s, containerId=%s, facilityId=%s, demand=%s, distance=%s, serviceTime=%s, transportCost=%s}",
            sa.getServiceAssignmentId(), sa.getContainerId(), sa.getFacilityId(), sa.getWasteDemand(), sa.getDistance(), sa.getServiceTime(), sa.getTransportCost()
        );
