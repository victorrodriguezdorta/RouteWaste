 ...
 * 
 * Data Transfer Object representing the request body for creating a new InfrastructurePlan.
 * This DTO is used in POST requests to the infrastructure plan endpoint.
 * 
