...
public class FacilityFieldMapper {
    ...
    static {
        ...
        FIELD_MAPPING.put("type", "facilityType");
        FIELD_MAPPING.put("facilityType", "facilityType");
        FIELD_MAPPING.put("status", "status");
        FIELD_MAPPING.put("createdAt", "createdAt");
        FIELD_MAPPING.put("updatedAt", "updatedAt");

        // Nested location fields (MongoDB dot notation)
        ...
        // Capacity fields (Value Objects - MongoDB will sort by the entire object by default)
        FIELD_MAPPING.put("storageCapacity", "storageCapacity");
        FIELD_MAPPING.put("processingCapacity", "processingCapacity");
        FIELD_MAPPING.put("unloadingTime", "unloadingTime");
        FIELD_MAPPING.put("openingCost", "openingFixedCost");
        FIELD_MAPPING.put("currentFillingLevel", "currentFillingLevel");
    }
